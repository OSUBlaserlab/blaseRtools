...
For example:
```{r, eval = FALSE, fig.align='center', fig.width=4.5, fig.height=3.5}
...
```{r, fig.align='center', fig.width=6.0, fig.height=3.5}
...
```{r, fig.align='center', fig.width=7.0, fig.height=3.5}
bb_var_umap(vignette_cds, 
            var = "density", 
            facet_by = "equipment", 
            cell_size = 2, 
